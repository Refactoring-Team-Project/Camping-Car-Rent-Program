...
public class SearchController extends Controller {
	...
	public void setMainView() {
		super.setMainView();
		this._mainView.addSearch1Listener(new mainButtonListener());
		this._mainView.addAdminTop10CompanySearch(new mainButtonListener());
		this._mainView.addAdminBlackCusRankSearch(new mainButtonListener());
		this._mainView.addAdminRepairShopRankSearch(new mainButtonListener());
	}
